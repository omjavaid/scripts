...
set FC=c:\\work\\llvm-dev\\build\\bin\\flang-new.exe
::
set NO_STOP_MESSAGE=1

cmake -G Ninja -DTEST_SUITE_FORTRAN=ON -DTEST_SUITE_COLLECT_COMPILE_TIME=ON -DTEST_SUITE_LIT=c:\\work\\llvm-dev\\build\\bin\\llvm-lit.py  -DTEST_SUITE_SUBDIRS="Fortran" ..\\llvm-test-suite
